...
<div align="center">
  ...
  <img alt="GitHub followers" src="https://img.shields.io/github/followers/neerajteja?label=Followers&style=social">
  <img src="https://img.shields.io/github/last-commit/neerajteja/neerajteja?label=Last%20Updated&color=blue">
...
- Completed multiple internships with IBM Skills Build, Shell, and leading tech companies
- Passionate about Machine Learning, Deep Learning, and Web Technologies
- Open to collaborate on innovative AI projects and open source contributions
- Learning Advanced AI algorithms and Cloud Computing

<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Courier+New&size=18&pause=500&color=00D9FF&center=true&vCenter=true&width=500&height=60&lines=while(learning)+%7B+code();+%7D;const+passion+=+'technology';console.log('Building+AI+solutions!');git+commit+-m+'Innovation+never+stops'" alt="Code Animation" />
</div>
...
<div align="center">
  <table>
    ...
    <tr>
      <td>Narayana Co Spark Campus</td>
      <td>Class XII - BIEAP (MPC)</td>
      <td>86%</td>
      <td>2023</td>
    </tr>
    <tr>
...
<div align="center">
  <img src="https://skillicons.dev/icons?i=c,cpp,python,java,js,html,css,tensorflow,mysql,git,vscode,github&theme=dark" />
</div>
...
|:---|:---|:---|
| **Face Recognition System** | AI-powered face recognition and attendance tracking | Python, OpenCV, ML |
| **E-Waste Classification** | ML model for environmental waste categorization | Python, AI/ML |
| **Employee Salary Prediction** | Deep Learning model for salary forecasting | Python, DL, Neural Networks |

### 💻 Web Development
| Project | Description | Tech Stack |
|:---|:---|:---|
| **Personal Portfolio Website** | Professional portfolio showcasing projects | HTML, CSS, JavaScript |
| **Digital Resume Builder** | Dynamic resume creation platform | HTML, CSS, JavaScript |
| **Responsive Page Layout** | Modern responsive web designs | HTML, CSS, JavaScript |

### 🗄️ Full Stack Development
| Project | Description | Tech Stack |
|:---|:---|:---|
| **Bus Ticket Booking System** | Complete booking management with GUI | Java, Databases |
| **Multi-Control Robot Car** | IoT-based robot control system | Hardware, Programming |
...
<img src="https://github-profile-summary-cards.vercel.app/api/cards/productive-time?username=neerajteja&theme=radical&utcOffset=5.5" />
...
<div align="center">
  <img src="https://metrics.lecoq.io/neerajteja?template=classic&base.header=0&base.activity=0&base.community=0&base.repositories=0&base.metadata=0&activity=1&activity.limit=5&activity.days=14&activity.filter=all&activity.visibility=all&activity.timestamps=false&config.timezone=Asia%2FKolkata" />
</div>
...
![Telugu](https://img.shields.io/badge/Telugu-Native-green?style=for-the-badge)
![French](https://img.shields.io/badge/French-Elementary-orange?style=for-the-badge)
...
<!--
**neerajteja/neerajteja** is a ✨ special ✨ repository because its `README.md` (this file) appears on your GitHub profile.
-->
